...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SitesPage.expire_at'
        db.add_column('pages_sitespage', 'expire_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Page.expire_at'
        db.add_column('pages_page', 'expire_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'SitesPage.expire_at'
        db.delete_column('pages_sitespage', 'expire_at')

        # Deleting field 'Page.expire_at'
        db.delete_column('pages_page', 'expire_at')
