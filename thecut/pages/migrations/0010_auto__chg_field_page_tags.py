...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.tags'
        db.alter_column('pages_page', 'tags', self.gf('tagging.fields.TagField')())

    def backwards(self, orm):

        # Changing field 'Page.tags'
        db.alter_column('pages_page', 'tags', self.gf('tagging.fields.TagField')(null=True))
